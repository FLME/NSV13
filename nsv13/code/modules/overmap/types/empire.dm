...
/obj/structure/overmap/nanotrasen/empire/battleship
	name = "Oleen-type heavy gunship" //  TODO unfuck the name
	desc = "A Draconic Empire ship carrying an impressive amount of armor and weapons." //TODO make a better description :)
...
/obj/structure/overmap/nanotrasen/empire/battleship/starter //the Unyielding
	name = "Halsey-type converted gunship"
